...
export const companyPanorama: PanoramaConfig = {
  ...
  embedUrl: 'https://maps.google.com/maps?layer=c&panoid=CIABIhDKo31uJt9a_drCnhehRYCJ&output=svembed',
  directUrl:
  ...
  thumbnailUrl:
    'https://lh3.googleusercontent.com/gps-cs-s/AHRPTWmZqCeywFgcEMWVVHkzIz8dfqSAupJVIiDRmq3WUZ-C_4xLfUAfDx_AitIOdQUkIDoPcXP5wBjD_Baed2V4UYQ4gMkudw01cUIRAvqZ2XgbmUaCUdmHiYAMf39t8xSX4DGkLNkDsNqWx72T=w800-h600-k-no',
};
...
export const galleryPanoramas: PanoramaConfig[] = [
  {
    ...
    embedUrl: 'https://maps.google.com/maps?layer=c&panoid=CIABIhB7A0qexOIn61VOkJAIWnII&output=svembed',
    directUrl:
    ...
    thumbnailUrl:
      'https://lh3.googleusercontent.com/gps-cs-s/AHRPTWm_RAbDByIS-zXCaCvzdr1XY9D03ACbEuJnMLrzvR7s8CJDoHmAqfe7Mo-YZJNgg32CIFeFrlhVlkHwUtL_T9948FAi2zI_TR-3ZAtMAq_YY5WQK7huDTc3B2Q4ZY-dS0u_Lz3TUnUwc9sd=w800-h600-k-no',
  },
  {
    id: 2,
    ...
    embedUrl: 'https://maps.google.com/maps?layer=c&panoid=CIABIhAt-HRIi5xE08_MFfLIb2Ug&output=svembed',
    directUrl:
    ...
    thumbnailUrl:
      'https://lh3.googleusercontent.com/gps-cs-s/AHRPTWnDBgGzEDjmaMd5-SiCwn7j85GWzBn-MhDYQllPdYNnzoPdXtr3vQIupGNt74KtgxGgbKHW7G0vEl69xpym2TmkILIuc44dftOQ9ysCKbDSi2VhKK2dGi6j1mwsof-Oq17DSk0kLEDIcUk7=w800-h600-k-no',
  },
  {
    id: 3,
    ...
    embedUrl: 'https://maps.google.com/maps?layer=c&panoid=CIABIhA2Derxj2W2jzr_zFyHUDNf&output=svembed',
    directUrl:
    ...
    thumbnailUrl:
      'https://lh3.googleusercontent.com/gps-cs-s/AHRPTWnQErCMDs6AiRwyxQuhqTkd_FwaJ8kh3dKTQ9FaigrqVnag_OOpe4agUBp1waSiIKbaKAJEvSsLPqZS7QVne5Bc093MhrSTCYoMiuG8lRGDz0cDTJcwM2P4sfDyWg8Pud0sduAZrfg2Yog=w800-h600-k-no',
  },
  {
    id: 4,
    ...
    embedUrl: 'https://maps.google.com/maps?layer=c&panoid=CIABIhCFs2Kiog80Yj7FqYqb4d2G&output=svembed',
    directUrl:
    ...
    thumbnailUrl:
      'https://lh3.googleusercontent.com/gps-cs-s/AHRPTWmTIXuABAVyBHdkI0d5W9biSrrFodYHgW0oXZZYc2QvavAEg9Bq0WWHE_Wxpa0sX2XiL5Rgesn8n4TxI_VnDBFn2zZkFua07JMuN83G5-lf6QINwHcY_OItuTTq2aLGq0hDFHzxY4JR488s=w800-h600-k-no',
  },
];
